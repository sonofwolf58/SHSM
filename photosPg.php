...
<head>
	...
	<title>PhotosPG - Sacred Heart - St Marys</title>
...
<?php 
// this section is development include. Once completed and working, move code to siteCommon.php
    include_once "./displayDirs.php";
?>
...
<?php
$downDir=displayDirs("./photos");
//displayPhotos("$downDir");
?>
